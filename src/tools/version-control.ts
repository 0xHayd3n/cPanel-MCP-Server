...
export function registerVersionControlTools(server: McpServer, client: CpanelClient) {
  ...
  server.tool(
    ...
    async ({ name, repository_root, source_repository }) => {
      ...
      return { content: [{ type: "text", text: `Git repository created: ${name}` }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ repository_root }) => {
      ...
      return { content: [{ type: "text", text: `Git repository deleted: ${repository_root}` }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ repository_root, branch }) => {
      ...
      return { content: [{ type: "text", text: `Git repository updated: ${repository_root}` }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ repository_root }) => {
      ...
      return { content: [{ type: "text", text: `Deployment triggered for: ${repository_root}` }] };
    }
  );
